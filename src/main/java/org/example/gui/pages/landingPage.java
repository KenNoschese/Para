...
public class landingPage extends JPanel implements ThemeManager.ThemeChangeListener {
    ...
    private RoundingOfPanels infoContainer;
    private JPanel infoTextPanel;
    private RoundingOfButtons startButton;
    private Images img;
    ...
    private void setupPanel() throws IOException, FontFormatException {
        ...
        JPanel headerPanel = factoryPanel.createHeaderPanel();
        JPanel footerPanel = factoryPanel.createFooterPanel();
    ...
    private JPanel createInfoContainer() throws IOException, FontFormatException {
        infoContainer = new RoundingOfPanels(sizeManager.getInstance().getBorderRadiusLarge());
    ...
    private RoundingOfButtons createStartButton() throws IOException, FontFormatException {
        startButton = new RoundingOfButtons("Start Now!");
    ...
    private JPanel createInstructionContainer() throws IOException, FontFormatException {
        ...
        instructContainer.add(factoryPanel.createStepPanel(
                1,
