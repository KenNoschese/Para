...
public class appTheme {
    public static final Color RED = new Color(0xd85259);
    public static final Color YELLOW = new Color(0xffe786);
    public static final Color BLUE = new Color(0xb7caef);
    public static final Color GREEN = new Color(0x84b477);
    public static final Color PINK = new Color(0xe8ced6);
